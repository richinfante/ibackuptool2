...
pub struct Sender {
    ...
    id: String,
    country: String,
    service: String, // uncanonicalized_id
                     // person_centric_id
}
...
pub fn localize_sender_id(
    index: &crate::infodump::address::AddressBookIndexed,
        ...
        for chat in &self.chats {
            ...
            for message in &chat.messages {
                ...
                writeln!(
                    ...
                    &chat_name_display,
                    sender_name,
                    message.text.as_ref().unwrap_or(&"(no content)".to_string())
                )?;
