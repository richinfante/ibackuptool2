...
mod tests {
    #[test]
    fn test_u32_read() {
        assert_eq!(super::as_u32_be(&[ 0xDE as u8, 0xAD as u8, 0xBE as u8, 0xEF as u8]), 0xDEADBEEF);
        assert_eq!(super::as_u32_le(&[ 0xEF as u8, 0xBE as u8, 0xAD as u8, 0xDE as u8]), 0xDEADBEEF);
    }
}
